...
<h1 class="text-center margin-top-1">Add Music</h1>
            ...
            <form action="add-music.php" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="custom-file">
                        <input type="file" class="custom-file-input" id="banner_img" name="banner_img" accept="image/*" required>
                ...
                <div class="form-group">
                    ...
                    <div class="custom-file">
                        <input type="file" class="custom-file-input" id="audio_file" name="audio_file" accept="audio/*" required>
